...
noise = 20 # 0-100
img = cv2.imread('/home/timur/PythonProjects/robotics/hw7/putin.jpg')
def on_slide():
    print('hello')
...
if __name__ == '__main__':
    while True:
        ...
        plt.imshow(mag_spectrum(cv2.imread('/home/timur/PythonProjects/robotics/hw7/putin.jpg', 0)), cmap='gray')
        plt.show()
        cv2.waitKey(1)
